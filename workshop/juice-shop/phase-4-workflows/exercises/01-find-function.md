...
> Where is the `login` handler defined and called in Juice Shop?
...
**Debrief question:** what's the prompt you'd use if you wanted Claude to not just find it but also tell you whether it handles rate-limiting or lockout?
