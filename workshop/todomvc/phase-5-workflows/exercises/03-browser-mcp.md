...
> Open `http://localhost:3000` via Playwright MCP. Add three todos: "write tests", "run tests", "ship it". Toggle the second one as complete. Screenshot the result and describe what you see.
...
- Does it stay on `localhost:3000`? Push back if it tries to navigate elsewhere.
